  ...
  return (
    <>
      <div className="flex flex-wrap items-end justify-between gap-4">
        ...
        <Button href="/dashboard/events/add-event">Create event</Button>
      </div>
      <ul className="mt-10">
              ...
              <div className="flex items-center justify-between">
                <div key={event.id} className="flex gap-6 py-6">
                  <div className="w-32 shrink-0">
                    <Link href={event.url || '/test'} aria-hidden="true">
                      <img className="aspect-[3/2] rounded-lg shadow" src={event.imgUrl} alt="" />
                    </Link>
                  </div>
                  <div className="space-y-1.5">
                    <div className="text-base/6 font-semibold">
                      <Link href={event.imgUrl || '/test'}>{event.name}</Link>
                    </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <Dropdown>
                    ...
                    <DropdownMenu anchor="bottom end">
                      <DropdownItem href={event.url || '/test'}>View</DropdownItem>
